...
const Footer = () => {
    return (
        <footer className="p-10 mt-14 footer bg-neutral text-neutral-content">
            <div className="items-center justify-center grid-flow-col mx-auto align-middle">
                <img className='w-[100px]' src={logo} alt="" />
                <p>Copyright © 2022 - All right reserved</p>
            </div>
            <div className="grid-flow-col gap-4 mx-auto md:place-self-center md:justify-self-end">
